...
class CourseServiceTest {
    ...
    void shouldUpdateCourse() {
        ...
        CourseResponseDTO updatedResponse = new CourseResponseDTO(1L, "Java Avançado", "José", "jose@gmail.com");
        ...
        CourseResponseDTO result = courseService.update(1L, updatedRequest.name(), updatedRequest.coordinatorId());
