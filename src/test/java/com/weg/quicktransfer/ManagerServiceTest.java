...
class ManagerServiceTest {
    ...
    void shouldUpdateManager() {
        ...
        ManagerResponseDTO updatedResponse = new ManagerResponseDTO(1L, "Manager Atualizado", "manager02", "manager2@dominio.com", null);
        ...
        ManagerResponseDTO result = managerService.update(1L, updatedRequest.name(), updatedRequest.email(), updatedRequest.email());
